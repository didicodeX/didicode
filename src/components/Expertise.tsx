    ...
    <section className="py-16 sm:py-20 lg:py-24 xl:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg lg:text-xl leading-8 text-primary-600 dark:text-primary-100">
        ...
        <div className="mx-auto mt-12 sm:mt-16 lg:mt-20 xl:mt-24 max-w-2xl lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-6 sm:gap-x-8 gap-y-12 sm:gap-y-16 lg:max-w-none lg:grid-cols-3">
            <div className="flex flex-col">
              <dt className="flex items-center gap-x-3 text-sm sm:text-base font-semibold leading-7 text-primary-900 dark:text-primary-100">
                <CreditCard className="h-5 w-5 flex-none text-primary-600 dark:text-primary-400" />
                Payment Processing
              </dt>
              <dd className="mt-4 flex flex-auto flex-col text-sm sm:text-base leading-7 text-primary-600 dark:text-primary-100">
